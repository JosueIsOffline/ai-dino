import { MOBILE_SPEED_FACTOR, OBSTACLE_DOUBLE_SPAWN_CHANCE, OBSTACLE_INTERVAL_FACTOR } from "../constants";
...
export class ObstacleSpawner {
    ...
    public update(deltaTime: number) {
        ...
        const spawnInterval = (this.state.width / BASE_MOVE_SPEED) / this.state.speed  * (isMobile ? MOBILE_SPEED_FACTOR : OBSTACLE_INTERVAL_FACTOR);
